...
- Ch6 KP[50] 关注联营/合营企业（权益法20%-50%）的顺流/逆流交易抵销：存货出资设立联营企业、从联营企业购入产品作为固定资产。
- Ch27 关注母子/子子公司间（持股>50%）的内部交易全额抵销。
- 判别：核心主体是联营/合营且采用权益法→ Ch6 KP[50]；核心主体是母子公司→ Ch27。

【Ch1 实质重于形式 特殊场景识别】（2026-06-10）
- 母公司承诺为子公司承担税费/债务 → 实质是权益性交易（对子公司的资本性投入）→ Ch1 KP[3] 实质重于形式，不是 Ch12 或有事项的预期补偿。
